...
using static RuTubeDownloader.Utils;
...
namespace RuTubeDownloader
{
    public partial class FrameRuTubeVideo : UserControl
    {
        ...
        private void pictureBoxVideoThumbnail_Paint(object sender, EventArgs e)
        {
            if (Thumbnail != null)
            {
                // Create a rectangle using the Rectangle class's properties instead of a non-existent constructor
                ...
                //Rectangle resizedThumbnailRect = thumbnailRect.ResizeTo(pictureBoxVideoThumbnail.Size)
                //    .CenterIn(pictureBoxVideoThumbnail.Rectangle);
        ...
        private void SetVideoInfo(RuTubeVideo video)
        {
            ...
            if (video != null)
            {
                ...
                Thumbnail = video.ImageData != null && video.ImageData.Length > 0 
                    ? /*Image.FromStream(video.ImageData)*/null : null;
            }
            else
            {
        ...
        private void btnDownload_Click(object sender, RoutedEventArgs e)
        {
            ...
            RuTubeAPI api = new RuTubeAPI();
            RuTubeVideo video = api.GetRuTubeVideo(VideoInfo.Id);
